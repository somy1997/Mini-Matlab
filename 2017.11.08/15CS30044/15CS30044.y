                                                                    ...
                                                                    switch($1)
                                                                    {
                                                                        ...
                                                                        case '-':
                                                                        	if($2.loc->tp == tp_matrix)
						                                                    {
		                                                                    	...
		                                                                    	glob_quad.emit(Q_RINDEX,$2.loc->name,"0",rows->name);
		                                                                    	glob_quad.emit(Q_LINDEX,"0",rows->name,$$.loc->name);
		                                                                    	glob_quad.emit(Q_RINDEX,$2.loc->name,str_of_int,cols->name);
		                                                                    	...
		                                                                    	int dest = next_instr;
		                                                                    	glob_quad.emit(Q_RINDEX,$2.loc->name,t1->name,t4->name);
		                                                                    	glob_quad.emit(Q_UNARY_MINUS,t4->name,t4->name);
...
assignment_expression:          conditional_expression {
                                ...
                                unary_expression assignment_operator assignment_expression {
                                                                                                ...
                                                                                                else if($1.do_dereference == true)
																								{
																									...
																									if($2 != '=')
																									{
																										t = curr_st -> gentemp($1.loc->tp_of_ptr);
																										glob_quad.emit(Q_RDEREF,$1.loc->name,t->name);
																									}             
																									//Q_PLUS=1,Q_MINUS,Q_MULT,Q_DIVIDE,Q_MODULO,Q_LEFT_OP,Q_RIGHT_OP,Q_XOR,Q_AND,Q_OR
																									switch($2)
																									{
																										case '=':
																												...
																												break;
																										case '*':
																												glob_quad.emit(Q_MULT,t->name,$3.loc->name,t->name);
																												break;
																										case '/':
																												glob_quad.emit(Q_DIVIDE,t->name,$3.loc->name,t->name);
																												break;
																										case '%':
																												glob_quad.emit(Q_MODULO,t->name,$3.loc->name,t->name);
																												break;
																										case '+':
																												glob_quad.emit(Q_PLUS,t->name,$3.loc->name,t->name);
																												break;
																										case '-':
																												glob_quad.emit(Q_MINUS,t->name,$3.loc->name,t->name);
																												break;
																										case '<':
																												glob_quad.emit(Q_LEFT_OP,t->name,$3.loc->name,t->name);
																												break;
																										case '>':
																												glob_quad.emit(Q_RIGHT_OP,t->name,$3.loc->name,t->name);
																												break;
																										case '&':
																												glob_quad.emit(Q_AND,t->name,$3.loc->name,t->name);
																												break;
																										case '^':
																												glob_quad.emit(Q_XOR,t->name,$3.loc->name,t->name);
																												break;
																										case '|':
																												glob_quad.emit(Q_OR,t->name,$3.loc->name,t->name);
																												break;
																									}
																									if($2 != '=')
																									{
																										glob_quad.emit(Q_LDEREF,t->name,$1.loc->name);
																									}
																								}
																								else
																								{
																									...
																									switch($2)
																									{
																										case '=':
																												...
																												break;
																										case '*':
																												glob_quad.emit(Q_MULT,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '/':
																												glob_quad.emit(Q_DIVIDE,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '%':
																												glob_quad.emit(Q_MODULO,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '+':
																												glob_quad.emit(Q_PLUS,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '-':
																												glob_quad.emit(Q_MINUS,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '<':
																												glob_quad.emit(Q_LEFT_OP,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '>':
																												glob_quad.emit(Q_RIGHT_OP,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '&':
																												glob_quad.emit(Q_AND,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '^':
																												glob_quad.emit(Q_XOR,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																										case '|':
																												glob_quad.emit(Q_OR,$1.loc->name,$3.loc->name,$1.loc->name);
																												break;
																									}
                                                                                                }
                                                                                                $$ = $3;
...
selection_statement:            IF '(' selection_expression ')' M statement N ELSE M statement {
                                ...
                                SWITCH '(' selection_expression ')' M statement {
																		backpatch($3.truelist,$5);
                                                                        $$ = merge($3.falselist,$6);
																	};
